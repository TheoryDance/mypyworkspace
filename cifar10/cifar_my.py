...
data_test['x0'] = to_one(data_test['x0'], has_param=True, param_x_mean=x_mean, param_x_max=x_max)

param = np.load('cifar_paramters_result2.npy').tolist()
result_test = mytest(data_test['x0'], param['best_w0'], param['best_b0'], param['best_w1'], param['best_b1'])
