...
sys.path.append('C:\\Users\\grand\\git\\mypyworkspace')
...
# 从文件中加载样本数据
data = np.load('data_volution.npy')
list_one = []
list_zero = []
target_one = []
target_zero = []
...
# make test data
x_test = np.linspace(-30, 30, 220)
y_test = np.linspace(-30, 30, 220)
...
print('best loss2: ', best_loss2, ', loss1: ', best_loss1)
# test
